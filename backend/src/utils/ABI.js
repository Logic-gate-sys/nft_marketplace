 ...
 */
export const setABI = (address, abi) => {
 ...
 */
export const ABIexists = (address) => {
 ...
 */
export const getABI_from_ttl_cache = (address) => {
 ...
 */
export const fetchAbiFromEtherscan = async (address, chainId = 11155111) => {
