...
export const MintForm = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      try {
          ...
          //user id 
          const { data } = await axios.get(`http://localhost/api/users/${user_address}`);
          ...
          const res = await axios.post(`http://localhost:3000/api/nfts/${user_id}`, payload, { headers: { "Content-Type": "multipart/form-data" } });
          console.log(res);
      } catch (error) {
          console.log(error);
      }
