    ...
    <div id="home-page" className="flex flex-col h-full gap-5 p-3">
      ...
      >
        <div id="hero-text" className="flex flex-col justify-center">
          <h1 className="m-auto text-center bg-gradient-to-r from-[#5C3EAF] to-[#D279F5] bg-clip-text text-transparent text-4xl font-black">
            BUY & SELL YOUR DESIGNS WITH EASE
          </h1>
          <p className="text-center w-[50%] self-center font-semibold">
            Not an NFT artist? No problem. With Mint-Muse, you can mint and
            sell your creations—art, designs, anything—without needing to be a
