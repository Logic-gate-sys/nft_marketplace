      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 border-b border-os-border bg-os-bg-tertiary px-4 lg:px-8 flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button className="p-2 rounded-lg hover:bg-os-bg-hover transition-colors">
              <svg className="w-6 h-6 text-os-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1 max-w-2xl mx-4">
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className="h-5 w-5 text-os-text-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 overflow-y-auto bg-os-bg-primary">
           <Routes>
            ...
            <Route path="/market/collection/:collectionId" element={<CollectionView />} /> 
            <Route path="/studio/collection/:collectionId" element={<StudioCollectionView />} /> 
           </Routes>
        </main>
      </div>
